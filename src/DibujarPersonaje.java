...
NivelJugando = juego.lvl;
      ...
      //	}
    	...
    	if ((juego.lvl == 3)&&(Jefe1 == false)){
    		...
    		enemigo.MovX = 1;
    		enemigo.MovY = 1;
    		Enemigo.VELOCIDAD_PEGAR = 75;
    		Enemigo.VELOCIDAD_SEGUIR = 9;
    	}
    		...
    		Enemigo.MovX = 2;
    		Enemigo.MovY = 2;
    		Enemigo.VELOCIDAD_PEGAR = 57;
    		Enemigo.VELOCIDAD_SEGUIR = 8;    	
    		}
    		...
    		Enemigo.MovX = 3;
    		Enemigo.MovY = 3;
    		Enemigo.VELOCIDAD_PEGAR = 110;
    		Enemigo.VELOCIDAD_SEGUIR = 7;
    	}
    	}
